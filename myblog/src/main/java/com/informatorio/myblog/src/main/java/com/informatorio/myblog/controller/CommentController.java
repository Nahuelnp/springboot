...
public class CommentController {
    ...
    @GetMapping("/comment/post/{post_id}/quantity/{num}")
    public ResponseEntity<?> getCommentByQuantity(@PathVariable Integer num,@PathVariable Long post_id) {
        List<Comment> lista = commentRepository.findAllByPostId(post_id).subList(0, num);
